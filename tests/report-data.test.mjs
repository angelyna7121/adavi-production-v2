...
test("supports decimal ownership and rejects invalid percentages",()=>{assert.equal(applyOwnershipToRow({...rows[0],current:1000,previous:900},33.33).current,333.3);for(const invalid of [0,-1,100.01,Number.NaN])assert.throws(()=>validateOwnershipPercentage(invalid),/greater than 0/);});
